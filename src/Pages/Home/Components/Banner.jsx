const Slider = () => {
  return (
    <div className="px-6 py-12 text-center md:px-12 lg:text-left bg-[#424242]">
      ...
      <div className="grid items-center lg:grid-cols-2">
        <div className="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
          <div
            ...
            <h1 className="mt-2 mb-16 text-4xl font-bold tracking-tight md:text-5xl xl:text-6xl text-stone-100">
              Arena Events <br /> <br /><span className="text-primary">for your Gaming</span>
